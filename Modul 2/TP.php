...
Algoritma Program
 1. Mulai
 2. Input Username dan Password pada label
 3. Klilk OK untuk submit
 4. Muncul validasi login sesuai dengan inputan sebelumnya
 5. Selesai
-->
	<head>
		<title>Tugas Praktikum</title>
		<!-- tag style untuk menghias halaman -->
		<style>
			body{
	...
	<body>
        ...
        <!-- untuk validasi inputan dimana bila input masih kosong dan harus huruf -->
		<script>
