...
-->
	...
	<body>
		...
		<form action="<?php $_SERVER['PHP_SELF'];?>" method="post">
			<input type="text" name="v1" placeholder="Nilai 1" value="<?php echo $_POST['v1']; ?>" required />
			...
			<input type="text" name="v2" placeholder="Nilai 2" value="<?php echo $_POST['v2']; ?>" required />
